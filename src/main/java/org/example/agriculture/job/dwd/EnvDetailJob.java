...
public class EnvDetailJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> kafkaOutputStream = dwdStream
                .map(new MapFunction<DwdEnvDetail, String>() {
                    private final ObjectMapper objectMapper = new ObjectMapper();

                    @Override
                    public String map(DwdEnvDetail data) throws Exception {
                        try {
                            // 将DwdEnvDetail对象转换为JSON字符串
        ...
        // 添加Kafka Sink
        kafkaOutputStream.addSink(kafkaProducer).name("Kafka DWD Env Detail Sink");
